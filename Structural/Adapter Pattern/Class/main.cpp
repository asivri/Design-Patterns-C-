...
/*
 ...
 Adapter Implementation Type: Class
...
//Adaptor class
class Translator: public Student, private TurkishStudent{
public:
    string speaksEnglish()
    {
        //This part is the different than the object implementation of the pattern.
        string _hello = speaksTurkish();
...
{
    //Adapter creation
    Student *sObj = new Translator();

    string word = sObj->speaksEnglish();
}